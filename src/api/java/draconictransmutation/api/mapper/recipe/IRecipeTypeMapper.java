package draconictransmutation.api.mapper.recipe;
...
public interface IRecipeTypeMapper {
	 ...
	 * @implNote Due to how the fakeGroupManager works, {@link draconictransmutation.api.nss.NSSFake} implementations should only be created in this method with
