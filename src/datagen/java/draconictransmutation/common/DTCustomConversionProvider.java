...
import draconictransmutation.api.data.ConversionGroupBuilder;
import draconictransmutation.api.data.CustomConversionBuilder;
import draconictransmutation.api.data.CustomConversionProvider;
...
public class DTCustomConversionProvider extends CustomConversionProvider {

	public DTCustomConversionProvider(@Nonnull DataGenerator generator) {
		super(generator);
	}

	@Override
	protected void addCustomConversions() {
		createConversionBuilder(DTCore.rl("metals"))
		...
		CustomConversionBuilder defaultBuilder = createConversionBuilder(DTCore.rl("defaults"))
