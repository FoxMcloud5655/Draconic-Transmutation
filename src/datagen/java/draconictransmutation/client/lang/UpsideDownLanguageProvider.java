...
import draconictransmutation.client.lang.FormatSplitter.Component;
import draconictransmutation.client.lang.FormatSplitter.FormatComponent;
import draconictransmutation.client.lang.FormatSplitter.MessageFormatComponent;
	...
	private static String convertMessageFormatCode(MessageFormatComponent component) {
		...
		if (formatStyle != null && component.isChoice()) {
			...
			try {
				...
				DTCore.LOGGER.warn("Failed to convert '{}' to an upside down choice format. Got: '{}' which was invalid.", formatStyle, newFormatStyle);
