...
import draconictransmutation.config.value.CachedBooleanValue;
import draconictransmutation.config.value.CachedDoubleValue;
import draconictransmutation.config.value.CachedFloatValue;
import draconictransmutation.config.value.CachedIntValue;
 ...
 */
public final class ServerConfig extends BaseDTConfig {
	...
	public static class Difficulty {
		...
		private Difficulty(IDTConfig config, ForgeConfigSpec.Builder builder) {
	...
	public static class Items {
		...
		private Items(IDTConfig config, ForgeConfigSpec.Builder builder) {
			builder.push("items");
	...
	public static class Effects {
		...
		private Effects(IDTConfig config, ForgeConfigSpec.Builder builder) {
	...
	public static class Misc {
		...
		private Misc(IDTConfig config, ForgeConfigSpec.Builder builder) {
			builder.push("misc");
	...
	public static class Cooldown {
		...
		private Cooldown(IDTConfig config, ForgeConfigSpec.Builder builder) {
		...
		public static class Player {
			...
			private Player(IDTConfig config, ForgeConfigSpec.Builder builder) {
		...
		public static class Pedestal {
			...
			private Pedestal(IDTConfig config, ForgeConfigSpec.Builder builder) {
