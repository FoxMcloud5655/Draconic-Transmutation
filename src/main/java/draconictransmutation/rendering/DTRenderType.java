package draconictransmutation.rendering;
...
public class DTRenderType extends RenderType {

	//Ignored
	private DTRenderType(String name, VertexFormat format, int drawMode, int bufferSize, boolean useDelegate, boolean needsSorting, Runnable setupTask, Runnable clearTask) {
